	...
	<table style="padding-top:50px;" border="0" cellpadding="0" width="100%">
	   <tr>
		  <td align="center" width="100%">
		    <img src="{{  asset('backoffice/img/emails/reminder.png') }}" alt="User" height="90">
		  </td>
		</tr>
	</table>
	<!-- TEXTO -->
	   ...
	   <tr>
		  	<td align="center" width="100%">
			    <table style="font-size:14px;padding:8px 13px;color:#ffffff;background-color:#0084B6;">
					<tr><td><a href="{{ route('contactsPageB') }}" target="_blank" style="color:#ffffff;text-decoration:none;background:#0084B6;">{!! trans('backoffice.authorizeBt') !!}</a></td></tr>
				</table>
			</td>
		</tr>
	</table>
	...
	<table style="padding-top:40px;" border="0" cellpadding="0" width="100%">
	   <tr>
		  	<td align="center" width="100%" style="color:#58595b;font-size:11px;line-height:15px;">
		    	{!! trans('backoffice.doesntWorkTx') !!} <a href="{{ route('contactsPageB') }}" style="text-decoration:none;color:#2fb385;" target="_blank">{{ route('contactsPageB') }}</a>
			</td>
		</tr>
	</table>
@stop