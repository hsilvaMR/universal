...
@section('content')
 ...
 <div class="container mt-5 mb-5">
     ...
     <div>
         <h1 class="text-black mb-5">Area de comunicação de Imagens </h1>
     </div>
...
<script src="{{ asset('backoffice/vendor/datatables/jquery.dataTables.min.js') }}"></script>
	<script>
		...
		/*$('.table-img-circle').css('height','50px')
		$('.table-img-circle').css('width':'auto')
		$('.table-img-circle').css('border-radius','50%')*/
