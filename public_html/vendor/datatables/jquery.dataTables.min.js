...
d[c]=e,"o"===b[1]&&Y(a[e])});a._hungarianMap=d}function J(a,b,c){a._hungarianMap||Y(a);var d;h.each(b,function(e){d=a._hungarianMap[e];if(d!==k&&(c||b[d]===k))"o"===d.charAt(0)?(b[d]||(b[d]={}),h.extend(!0,b[d],b[e]),J(a[d],b[d],c)):b[d]=b[e]})}function Fa(a){var b=m.defaults.oLanguage,c=a.sZeroRecords;!a.sEmptyTable&&(c&&"Sem dados disponíveis na tabela"===b.sEmptyTable)&&F(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&(c&&"Loading..."===b.sLoadingRecords)&&F(a,a,"sZeroRecords","sLoadingRecords");
...
oPaginate:{sFirst:"Primeira",sLast:"Última",sNext:"<i class=fa-chevron-right></i>",sPrevious:"<i class=fa-chevron-left></i>"},sEmptyTable:"Sem dados disponíveis na tabela",sInfo:"Mostrando _START_ a _END_ de _TOTAL_ registos",sInfoEmpty:"Sem resgistos com correspondência",sInfoFiltered:"(filtrados os _MAX_ total registos)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ registos",sLoadingRecords:"A carregar...",sProcessing:"A Processar...",sSearch:"",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Sem resgistos com correspondência"},oSearch:h.extend({},
...
" ui-corner-bl ui-corner-br"});var Mb=m.ext.pager;h.extend(Mb,{simple:function(){return["anterior","seguinte"]},full:function(){return["primeira","anterior","seguinte","última"]},numbers:function(a,b){return[Aa(a,b)]},simple_numbers:function(a,b){return["anterior",Aa(a,b),"seguinte"]},full_numbers:function(a,b){return["primeira","anterior",Aa(a,b),"seguinte","última"]},_numbers:Aa,numbers_length:7});h.extend(!0,m.ext.renderer,{pageButton:{_:function(a,b,c,d,e,f){var g=a.oClasses,j=a.oLanguage.oPaginate,i=a.oLanguage.oAria.paginate||
{},k,l,m=0,p=function(b,d){var n,r,t,s,v=function(b){Ta(a,b.data.action,true)};n=0;for(r=d.length;n<r;n++){s=d[n];if(h.isArray(s)){t=h("<"+(s.DT_el||"div")+"/>").appendTo(b);p(t,s)}else{k=null;l="";switch(s){case "ellipsis":b.append('<span class="ellipsis">&#x2026;</span>');break;case "primeira":k=j.sFirst;l=s+(e>0?"":" "+g.sPageButtonDisabled);break;case "anterior":k=j.sPrevious;l=s+(e>0?"":" "+g.sPageButtonDisabled);break;case "seguinte":k=j.sNext;l=s+(e<f-1?"":" "+g.sPageButtonDisabled);break;case "última":k=
