...
@section('content')
  <?php $arrayCrumbs = [ trans('backoffice.allUsers') => route('usersPageB') ]; ?>
  @include('backoffice/includes/crumbs')

  <div class="page-titulo">{{ trans('backoffice.allUsers') }}</div>
    ...
    <div class="modulo-scroll">
      <table class="modulo-body" id="sortable">
        <thead>
          ...
          <th>{{ trans('backoffice.Language') }}</th>
      ...
      <tbody>
        ...
        <tr id="linha_{{ $val['id'] }}">
          ...
          <td class="table-opcao">
            <a href="{{ route('usersEditPageB',['id'=>$val['id']]) }}" class="table-opcao"><i class="fas fa-pencil-alt"></i>&nbsp;{{trans('backoffice.Edit')}}</a>&ensp;
            <a href="{{ route('usersLoginB',['id'=>$val['id']]) }}" class="table-opcao" target="_blank"><i class="fas fa-sign-in-alt"></i>&nbsp;{{trans('backoffice.logIn')}}</a>&ensp;
