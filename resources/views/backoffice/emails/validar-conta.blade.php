	...
	<table style="padding-top:50px;" border="0" cellpadding="0" width="100%">
	   <tr>
		  <td align="center" width="100%">
		    <img src="{{  asset('backoffice/img/emails/activate.png') }}" alt="Activate" height="90">
		  </td>
		</tr>
	</table>
	<!-- TEXTO -->
	   ...
	   <tr>
		  	<td align="center" width="100%">
			    <table style="font-size:14px;padding:8px 13px;color:#ffffff;background-color:#0084B6;">
					<tr><td><a href="{{ route('emailActivationPage',['token' => $token]) }}" target="_blank" style="color:#ffffff;text-decoration:none;background:#0084B6;">{!! trans('emails.activateBt') !!}</a></td></tr>
				</table>
			</td>
		</tr>
	</table>
	...
	<table style="padding-top:40px;" border="0" cellpadding="0" width="100%">
	   <tr>
		  	<td align="center" width="100%" style="color:#58595b;font-size:11px;line-height:15px;">
		    	{!! trans('emails.doesntWorkTx') !!} <a href="{{ route('emailActivationPage',['token' => $token]) }}" style="text-decoration:none;color:#2fb385;" target="_blank">{{ route('emailActivationPage',['token' => $token]) }}</a>
			</td>
		</tr>
	</table>
@stop