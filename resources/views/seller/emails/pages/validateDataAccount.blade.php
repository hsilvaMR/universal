	...
	<table style="padding-top:40px;background-color:#fff;padding:40px;" border="0" cellpadding="0" width="100%">
	   <tr>
		    <td align="center" width="100%" style="color:#333;font-size:16px;line-height:20px;">
		        ...
		        <p style="margin-top:20px;">O utilizador com o <b>#{{ $dados['id_comerciante'] }}</b> da empresa <b>{{ $dados['nome_empresa'] }}</b>, com o <b>#{{ $dados['id_empresa'] }}</b> alterou os seus dados da empresa. Será necessário aprovar os dados.</p>
			</td>
		</tr>
	</table>
