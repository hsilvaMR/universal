	...
	<table style="padding-top:40px;background-color:#fff;padding:40px;" border="0" cellpadding="0" width="100%">
	   <tr>
		    <td align="center" width="100%" style="color:#333;font-size:16px;line-height:20px;">
		        ...
		        <p style="margin-top:20px;">{!! trans('site_v2.restore_tx') !!}</p>
			</td>
		</tr>
	</table>
		...
		<tr style="vertical-align: top;" valign="top" align="center">
			<td style="word-break: break-word; vertical-align: top; border-collapse: collapse;" valign="top">	
				...
				<a href="{{ route('restorePasswordPageV2',$dados['token']) }}" target="_blank"><div style="text-decoration:none;display:block;color:#ffffff;background-color:#1974d8;border-radius:40px;-webkit-border-radius:40px;-moz-border-radius:40px;width:100%; width:calc(100% - 2px);border-top:1px solid #1974d8;border-right:1px solid #1974d8;border-bottom:1px solid #1974d8;border-left:1px solid #1974d8;padding-top:5px;padding-bottom:5px;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;">
					...
					<span style="font-size: 16px; line-height: 32px;color:#ffffff;">{!! trans('site_v2.restore_bt') !!}</span>
					</span>
				</div></a>
	...
	<table style="padding:40px 180px 0px 180px;text-align:center;color:#666;font-size:12px;" border="0" cellpadding="0" width="100%">
	   <tr>
		  	<td align="center" width="100%" style="line-height:15px;">
		    	{!! trans('site_v2.doesntWork_tx') !!} <a href="{{ route('restorePasswordPageV2',$dados['token']) }}" style="text-decoration:none;color:#1974d8;" target="_blank">{{ route('restorePasswordPageV2',$dados['token']) }}</a>
			</td>
