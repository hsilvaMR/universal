		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="mod-incentives-angle">
					<a href="{{ route('securityPageV2') }}"><i class="fas fa-chevron-left"></i> {{ trans('site_v2.Security') }}</a>
					<a href="{{ route('cookiesPageV2') }}" class="float-right">{{ trans('site_v2.Cookies_Third_Services') }} <i class="fas fa-chevron-right"></i></a>
				</div>
			</div>
		</div>
	</div>
