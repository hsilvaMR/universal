	...
	<table style="padding-top:40px;background-color:#fff;padding:40px;" border="0" cellpadding="0" width="100%">
	   <tr>
		    <td align="center" width="100%" style="color:#333;font-size:16px;line-height:20px;">
		    	<img height="75" src="{{ asset('img/emails/warning.png') }}">
		        <p style="margin-top:20px;">O utilizador com o <b>#{{ $dados['id_comerciante'] }}</b> da empresa <b>{{ $dados['nome_empresa'] }}</b>, com o <b>#{{ $dados['id_empresa'] }}</b> alterou os seus dados pessoais. Será necessário aprovar os dados do utilizador.</p>
			</td>
		</tr>
	</table>
