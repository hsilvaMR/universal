...
<div class="mod-incentives">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9">
				<h2 class="tx-navy">{{ trans('site_v2.Internalization') }}</h2>
				<div class="mod-incentives-txt">{!! $internationalization['internationalization_txt']!!}</div>
				<img style="max-width:650px;" src="{{ asset('site_v2/img/site/norte2020.jpg') }}">
				<div class="mod-incentives-angle">
					<a href="{{ route('qualificationPageV2') }}"><i class="fas fa-chevron-left"></i> {{ trans('site_v2.Qualification') }}</a>
				</div>
			</div>
		</div>
	</div>
