	...
	<table style="padding-top:40px;background-color:#fff;padding:40px;" border="0" cellpadding="0" width="100%">
	   <tr>
		    <td align="center" width="100%" style="color:#333;font-size:16px;line-height:20px;">
		    	<img height="75" src="{{ asset('backoffice/img/emails/gift.png') }}">
		        <p style="margin-top:20px;">A solicitação #{{ $dados['id'] }}, encontra-se no estado <b>{{ $dados['estado'] }}</b>. Acompanhe a solicitação dos seus prémios através da área reservada.</p>
			</td>
		</tr>
	</table>
