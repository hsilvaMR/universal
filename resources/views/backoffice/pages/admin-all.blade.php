...
@section('content')
  <?php $arrayCrumbs = [ trans('backoffice.Managers') => route('adminAllPageB') ]; ?>
  @include('backoffice/includes/crumbs')

  <div class="page-titulo">
    {{ trans('backoffice.Managers') }}
  </div>
  	    ...
  	    <thead>
            ...
            <td>{!! $val['tipo'] !!}</td>
    			  ...
    			  <td class="table-opcao">
    				<a href="{{ route('adminEditPageB',['id'=>$val['id']]) }}" class="table-opcao"><i class="fas fa-pencil-alt"></i>&nbsp;{{trans('backoffice.Edit')}}</a>&ensp;
