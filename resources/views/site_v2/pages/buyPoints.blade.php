...
<section class="min-height">
  ...
  <div class="codes-bg" style="height:190px;"></div>
    ...
    <div class="container">
      ...
      <div style="padding-bottom:120px;">
        <div class="cart overflowX">
          <table class="table table-striped table-datos" style="margin:0px;border:none;">
            <thead>
              <tr class="table-thead font16" style="background-color:#fbfbfb;border-bottom: 1px solid #eee;border-top: 1px solid #eee;">
                
                <th class="cart-table" scope="col" style="padding-left:45px!important;">{{ trans('site_v2.Article') }}</th>
            ...
            <tbody>
                ...
                <td class="cart-width-td" scope="row" style="white-space:nowrap;">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-5">
                      ...
                      <div class="cart-div-img" style="float:none;margin-left:35px;margin-top:10px;"><img src="site_v2/img/site/bola.png"></div>
              ...
              <tr class="cart-height-line" style="white-space:nowrap;">
                <td class="cart-width-td">
                  <div class="row">
                    <div class="col-lg-5">
                      <div class="cart-div-cupao" style="float:left;line-height:90px;"><img src="site_v2/img/cart/carrinho-pontos.png"></div>
                    </div>
                    <div class="col-lg-7">
...
<div class="bg-gradient-blue">
  <div class="premium-banner">
    <div class="container">
      ...
      <a href="{{ route('premiumPageV2') }}"><button class="bt-gray tx-transform">{{ trans('site_v2.View_All_Awards') }}</button></a>
    </div>
  </div>
</div>
@stop
