...
{{--  form  --}}
<<<<<<< HEAD <form id="@if($funcao=='addComuni'){{'addComunication'}}@else {{'editComunication'}} @endif" method="POST"
    ...
    <form id="@if($funcao=='addComuni'){{'addComunication'}}@else {{'editComunication'}} @endif" method="POST"
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <select class="select2" name="tipo">
                    ...
                    <<<<<<< HEAD=======<option value="Documento" @if(isset($obj->tipo)&& $obj->tipo=='Documento')
                        selected @endif
                        >{{ trans('backoffice.comuniFrTypeDoc') }}</option>
                        >>>>>>> server
                </select>
            </div>
            {{--  Ficheiro --}}
            <div class="col-lg-6">
                ...
                <div class="div-50">
                    ...
                    <<<<<<< HEAD <input id="selecao-arquivo_xs" type="file" name="ficheiro"
                        onchange="lerFicheiros(this,'uploads_xs');" accept="image/*">
                        =======
                        <input id="selecao-arquivo_xs" type="file" name="ficheiro"
                            onchange="lerFicheiros(this,'uploads_xs');">
                        >>>>>>> server
                </div>
        ...
        <label id="labelErros" class="av-100 av-vermelho display-none"><span id="spanErro"></span> <i
                class="fas fa-times" onclick="$(this).parent().hide();"></i></label>
    </form>
