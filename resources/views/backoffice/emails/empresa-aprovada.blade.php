	...
	<table style="padding-top:50px;" border="0" cellpadding="0" width="100%">
	   <tr>
		  <td align="center" width="100%">
		    <img src="{{  asset('backoffice/img/emails/approved.png') }}" alt="Approved" height="90">
		  </td>
		</tr>
	</table>
	<!-- TEXTO -->
	<table style="padding-top:40px;" border="0" cellpadding="0" width="100%">
	   <tr>
		    <td align="center" width="100%" style="color:#58595b;font-size:14px;line-height:20px;">
		        {!! trans('backoffice.ApprovedCompanyTx') !!}
			</td>
		</tr>
	</table>
	<!-- BOTAO -->
	   ...
	   <tr>
		  	<td align="center" width="100%">
			    <table style="font-size:14px;padding:8px 13px;color:#ffffff;background-color:#0084B6;">
					<tr><td><a href="{{ route('loginPageV2') }}" target="_blank" style="color:#ffffff;text-decoration:none;background:#0084B6;">{!! trans('backoffice.ApprovedCompanyBt') !!}</a></td></tr>
				</table>
			</td>
		</tr>
	</table>
