	...
	<table style="padding-top:40px;background-color:#fff;padding:40px;" border="0" cellpadding="0" width="100%">
	   <tr>
		    <td align="center" width="100%" style="color:#333;font-size:16px;line-height:20px;">
		    	<img height="75" src="{{ asset('backoffice/img/emails/sent.png') }}">
		        <p style="margin-top:20px;">A encomenda #{{ $dados['id'] }} do armazém <b>{{ $dados['armazem'] }}</b>, será expedida no dia <b>{{ $dados['data'] }}</b>. Acompanhe a sua encomenda através da área reservada.</p>
			</td>
		</tr>
	</table>
