	...
	<table style="padding-top:40px;background-color:#fff;padding:40px;" border="0" cellpadding="0" width="100%">
	   <tr>
		    <td align="center" width="100%" style="color:#333;font-size:16px;line-height:20px;">
		    	...
		    	<img  height="75" src="{{ asset('site_v2/img/emails/success.png') }}">
		        <p style="margin-top:20px;">NOVA ENCOMENDA</p>
			</td>
		</tr>

		<tr>
		    <td width="100%" style="color:#333;font-size:16px;line-height:20px;">
		        Nome : {{ $dados['nome'] }}<br>
		        Email : {{ $dados['email'] }}<br>
		        Morada : {{ $dados['morada'] }}<br>
		        Número de porta : {{ $dados['numero_porta'] }}<br>
		        Código postal : {{ $dados['codigo_postal'] }}<br>
		        Localidade : {{ $dados['localidade'] }}<br>
		        <p style="margin-top:30px;">Código promocional utilizado : {{ $dados['codigo'] }} <b> {{ $dados['codigo_descricao'] }} </b></p>
		        Encomenda :<br> {{ $dados['mensagem'] }}<br>
			</td>
		</tr>
	</table>
	...
	<table bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" class="nl-container" role="presentation" style="table-layout: fixed; vertical-align: top; min-width: 320px; Margin: 0 auto; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #FFFFFF; width: 100%;padding-bottom:10px;" valign="top" width="100%">
		...
		<tr style="vertical-align: top;" valign="top" align="center">
			<td style="word-break: break-word; vertical-align: top; border-collapse: collapse;" valign="top">	
				...
				<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 0px; padding-right: 30px; padding-bottom: 30px; padding-left: 30px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ route('homePageV2') }}" style="height:31.5pt; width:150pt; v-text-anchor:middle;" arcsize="96%" stroke="false" fillcolor="#1974d8"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:'Trebuchet MS', Tahoma, sans-serif; font-size:16px"><![endif]-->
				<a href="{{ route('homePageV2') }}" target="_blank"><div style="text-decoration:none;display:block;color:#ffffff;background-color:#1974d8;border-radius:40px;-webkit-border-radius:40px;-moz-border-radius:40px;width:100%; width:calc(100% - 2px);;border-top:1px solid #1974d8;border-right:1px solid #1974d8;border-bottom:1px solid #1974d8;border-left:1px solid #1974d8;padding-top:5px;padding-bottom:5px;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;">
					<span style="padding-left:5px;padding-right:5px;font-size:16px;display:inline-block;">
					<span style="font-size: 16px; line-height: 32px;color:#ffffff;">{!! trans('site_v2.Visit_our_website') !!}</span>
					</span>
				</div></a>
